...
export const Separator = (props) => (
    <Svg width={900} height={116} xmlns="http://www.w3.org/2000/svg" {...props}>
        <Path
        d="m0 78.588 37.491-4.8c37.492-4.9 124.504-24.877 187.457-23.4 88.77 2.083 187.509 55.56 262.492 45.36 74.982-10.1 145.028-38.423 219.382-41.215 64.674-2.43 104.292.084 192.972 21.435v38.624H0Z"
        fill="#8977fd"
        style={{
            strokeWidth: 0.999885,
        }}
        />
        <Path
        d="M-.744 28.803c74.285 37.787 228.796 79.983 294.85 78.03 74.983-2.4 80.808-31.545 155.791-32.445 74.983-.8 137.728 41.102 212.711 39.402 90.69-6.511 155.114-4.163 237.186-45.764v47.618H0Z"
        fill="#c5b5fa"
        style={{
            strokeWidth: 0.999885,
        }}
        />
        <Path
        d="M0 79.985c87.134 25.76 165.24 14.612 244.913 4.596 85.412-10.739 186.517-29.921 261.5-25.121 74.983 4.8 146.995 31.57 215.193 29.375 68.198-2.195 95.66-9.798 178.188-29.106v56.967H0Z"
        fill="#f5f5f5"
        style={{
            strokeWidth: 0.999885,
        }}
